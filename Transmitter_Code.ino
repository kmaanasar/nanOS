...
const int PIN_RF69_CS     = D6;   // RFM69 Chip Select
const int PIN_RF69_INT    = D7;   // RFM69 Interrupt
const int PIN_RF69_RST    = D8;   // RFM69 Reset
...
// RFM69 Radio
RH_RF69 rf69(PIN_RF69_CS, PIN_RF69_INT);
...
void initialize_radio() {
  ...
  rf69.setTxPower(20, true);  // PA_BOOST enabled for high power module
  radioAvailable = true;
  Serial.println("RFM69 radio initialized OK!");
}
